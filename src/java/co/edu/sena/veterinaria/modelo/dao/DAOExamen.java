...
/**
 * Clase de acceso a los datos de la tabla examen de la base de datos.
 *
...
public class DAOExamen {
    ...
    /**
     * Metodo envia la peticion para ejecutar el procedimiento registrarExamen
     * en la base de datos.
     *
     ...
     * @throws java.lang.Exception Si existe un error al conectarse a la base de
     * datos.
     */
